...
public interface ShoppingCartMapper {
    ...
    public List<ShoppingCartDTO> listShoppingCartToListShoppingCartDTO(List<ShoppingCart> shoppingCarts);
    public List<ShoppingCart> listShoppingCartDTOToListShoppingCart(List<ShoppingCartDTO> shoppingCartDTOs);
}
